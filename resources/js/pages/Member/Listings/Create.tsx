                        ...
                        <div className="p-6 bg-white border-b border-gray-200">
                            ...
                            <div className="space-y-6">
                                <div className="bg-white shadow sm:rounded-lg p-6 mb-6">
                                    ...
                                    {files.length > 0 && (
                                    <div className="mt-6">
                                        <h4 className="text-sm font-medium text-gray-700 mb-2">Uploaded Images
                                            ({files.length})</h4>
                                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                            {files.map((file, index) => (
                                            <div key={index} className="relative group">
                                                <div className={`aspect-w-1 aspect-h-1 rounded-md overflow-hidden
                                                    ${file.isPrimary ? 'ring-2 ring-indigo-500' : '' }`}>
                                ...
                                <form onSubmit={submit} className="space-y-6">
                                    <ListingForm data={form.data} setData={form.setData} errors={form.errors}
                                        ...
                                        realEstateTypes={realEstateTypes} user={auth.user} onCancel={()=>
                                        router.get(route('member.listings.index'))}
                                        />
